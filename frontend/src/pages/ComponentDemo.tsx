  ...
  return (
    <div className="neo-container">
      ...
      <div className="neo-card neo-mb-3">
        ...
        <div className="neo-mt-2">
          <div className="form-group">
            ...
            <input type="text" className="neo-input" placeholder="Enter text here" />
          </div>
          ...
          <div className="form-group">
            ...
            <span className="neo-ml-2">{isToggled ? 'Toggle is ON' : 'Toggle is OFF'}</span>
          </div>
        </div>
      </div>
      ...
      <div className="neo-card neo-mb-3">
        ...
        <div className="neo-mt-2">
          <div className="neo-error">This is an error message. Something went wrong!</div>
          <div className="neo-success">
            This is a success message. Operation completed successfully!
          </div>
          <div className="neo-warning">This is a warning message. Pay attention to this!</div>
          <div className="neo-info">This is an information message. Just letting you know!</div>
        </div>
      </div>
        ...
        <div className="neo-mt-2">
          ...
          <div className="neo-mt-3">
            <div className="neo-tooltip">
              Hover over me
              <span className="neo-tooltip-text">
                This is a tooltip with additional information!
              </span>
            </div>
          </div>
        </div>
      ...
      <div className="neo-mb-3">
        ...
        <div className="neo-d-flex neo-flex-wrap neo-gap-2 neo-mt-2">
          ...
          <div
            className="neo-card"
            style={{ width: '200px', backgroundColor: 'var(--alt-primary)', color: 'white' }}
          >
            <h3>Colored Card</h3>
          ...
          <div
            className="neo-card"
            style={{ width: '200px', backgroundColor: 'var(--accent-color)' }}
          >
            <h3>Accent Card</h3>
